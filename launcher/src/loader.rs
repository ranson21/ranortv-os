...
fn add_builtin_apps(state: &mut LauncherState) {
    let builtin_apps = vec![
            App {
                ...
                background: "assets/images/MoviesBackground.png".to_string(),
                installed: true,
            ...
            App {
                ...
                background: "assets/images/MusicBackground.png".to_string(),
                installed: true,
                version: "1.0.0".to_string(),
                category: "Entertainment".to_string(),
            },
            App {
                ...
                background: "assets/images/PhotosBackground.png".to_string(),
                installed: true,
                version: "1.0.0".to_string(),
            ...
            App {
                ...
                background: "assets/images/SettingsBackground.png".to_string(),
                installed: true,
                version: "1.0.0".to_string(),
            ...
            App {
                ...
                background: "assets/images/AppStoreBackground.png".to_string(),
                installed: true,
                version: "1.0.0".to_string(),
                category: "System".to_string(),
            },
